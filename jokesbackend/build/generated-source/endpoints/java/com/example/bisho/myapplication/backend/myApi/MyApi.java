 ...
 * on 2017-01-18 at 03:32:20 UTC 
 * Modify at your own risk.
 */

package com.example.bisho.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://builditbigger-155701.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.example.bisho.myapplication.backend.myApi.model.Jokes> {

    private static final String REST_PATH = "jokes/{joke}";
    ...
    protected GetJoke(java.lang.String joke) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.bisho.myapplication.backend.myApi.model.Jokes.class);
  ...
  public class SayHi extends MyApiRequest<com.example.bisho.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.bisho.myapplication.backend.myApi.model.MyBean.class);
